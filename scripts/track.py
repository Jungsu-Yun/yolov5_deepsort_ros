...
from yolov5.utils.datasets import LoadImages, LoadStreams, LoadImagesTopic
...
def detect(opt):
    ...
    if webcam == "0":
        ...
        dataset = LoadImagesTopic(cv_image, img_size=imgsz)
    else:
...
if __name__ == '__main__':
    ...
    rospy.init_node("yolo_v5_deepsort", anonymous=True)
    image_sub = rospy.Subscriber("/image_raw", Image, image_callback, (args))
